...
def testIntent():
    ...
    # open_close
    print("[TEST] open_close")
    inputLIST = ['收盤收30.63元']
    testLoki(inputLIST, ['open_close'])
    print("")

    # up_down
    print("[TEST] up_down")
    inputLIST = ['貶2.5分']
    testLoki(inputLIST, ['up_down'])
    print("")

    # turnover
    print("[TEST] turnover")
    inputLIST = ['成交金額7.67億美元']
    testLoki(inputLIST, ['turnover'])
    print("")

    # range
    print("[TEST] range")
    inputLIST = ['交易區間為30.71元至30.735元']
    testLoki(inputLIST, ['range'])
    print("")
